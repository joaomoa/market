  ...
  const NOTICIAS = {
    ...
    house: {
      up: [
        ...
        'Muita gente quer casa perto da escola! Procura a subir, preço também.',
        'O inverno veio cedo! As obras atrasaram.',
        'Os canalizadores são poucos! As casas novas demoram.',
        'Uma fábrica de portas fechou! Menos oferta de portas, casas a subir.',
        'Há poucos eletricistas disponíveis! As casas novas demoram, preço a subir.',
      ...
      down: [
        ...
        'Os duendes construíram muitas casas! Oferta enorme, preço a cair.',
    ...
    empresa: {
      ...
      down: [
        ...
        'O lápis mágico apagou os testes! Os pais deixaram de comprar.',
        ...
        'Os duendes da empresa estão em pausa! Produção atrasada.'
      ],
      stable: [
    ...
    carro: {
      up: [
        ...
        'Fizeram um carro cor de arco-íris! Os pais valorizaram e compraram.',
      ...
      down: [
        ...
        'O estacionamento no centro ficou caro! Muita gente preferiu vender o carro.',
        ...
        'As famílias decidiram vender o carro! Preferem gastar noutra coisa.',
